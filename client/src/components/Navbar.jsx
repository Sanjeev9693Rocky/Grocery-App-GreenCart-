...
const Navbar = () => {
    ...
    return (
        <nav className="w-full flex items-center justify-between px-6 md:px-14 lg:px-18 xl:px-32 py-3 border-b border-gray-300 bg-white  transition-all fixed top-0 z-50">
