...
const Navbar = () => {
    ...
    return (
        <nav className="w-full flex items-center justify-between px-6 md:px-14 lg:px-18 xl:px-32 py-3 border-b border-gray-300 bg-white  transition-all sticky top-0 z-50">
            ...
            {/* Desktop Menu */}
            <div className="hidden sm:flex items-center gap-7 text-sm xl:text-base">
            ...
            <button onClick={navigate} className="cursor-pointer px-6 py-2 mt-2 bg-primary hover:bg-primary-dull transition text-white rounded-full text-sm">
                Logout
            </button>
                ) }
